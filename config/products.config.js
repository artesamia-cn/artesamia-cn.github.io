...
const PRODUCTS_CONFIG = [
  {
    ...
    descripcion2: "🌟Es el obsequio ideal para sorprenderlo en su día y dejar un recuerdo emotivo que combina elegancia, cariño y utilidad.<br><b>Incluye:</b>",
    caracteristicas: [
  ...
  },
   {
    ...
    descripcion2: "✨Es el regalo ideal para sorprender a papá en su día o para complementar sus momentos de celebración favoritos.<br><b>Incluye:</b>",
    caracteristicas: [
      "⚡ Grabado a láser con acabados de calidad.",
    ...
    descripcion2: "✨Es el obsequio ideal para sorprenderlo en su día y dejar un recuerdo emotivo que usará siempre.<br><b>Incluye:</b>",
    caracteristicas: [
      "⚡ Grabado a láser con acabados de calidad.",
  ...
  },
  {
    ...
    descripcion2: "Es el obsequio ideal para celebrar este Día del Padre con un regalo que combina estilo, cariño y buen gusto.<br><b>Incluye:</b>",
    caracteristicas: [
      "⚡ Grabado a láser con acabados de calidad.",
  ...
  },
  {
    ...
    descripcion2: "Es el detalle ideal para colocar en su escritorio, velador o ese rincón especial, combinando practicidad y sentimiento.<br><b>Incluye:</b>",
    caracteristicas: [
  ...
  },
  {
    ...
    descripcion2: "Es la opción ideal para matrimonios, bautizos o cualquier ocasión especial.<br><b>Incluye:</b>",
    caracteristicas: [
  ...
  },
  {
    ...
    descripcion2: "Es el souvenir ideal para regalar a tus invitados y dejar un detalle emotivo que combina diseño, cariño y utilidad en su día a día.<br><b>Incluye:</b>",
    caracteristicas: [
  ...
  },
  {
    ...
    descripcion2: "Es el souvenir ideal para regalar a tus invitados, dejando un recuerdo delicado que combina aroma, cariño y utilidad.<br><b>Incluye:</b>",
    caracteristicas: [
  ...
  },
  {
    ...
    descripcion2: "Es el regalo ideal para agradecimientos, fechas importantes o simplemente como un recordatorio diario lleno de significado.<br><b>Incluye:</b>",
    caracteristicas: [
      "🎁 Bolsita de lino",
  ...
  },
  {
    ...
    descripcion2: "Es el reconocimiento ideal para regalar como un agradecimiento especial para ese profesor o profesora inolvidable.<br><b>Incluye:</b>",
    caracteristicas: [
